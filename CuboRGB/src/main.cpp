...
void GeraMalhaCubo(GLuint resolucao, std::vector<Vertice> &Vertices
	...
	Vertices = {
		// vertices da base
		{point_a, {BLUE}, {0.0f, 0.0f}},
		{point_b, {MAGENTA}, {1.0f, 0.0f}},
		{point_c, {YELLOW}, {1.0f, 1.0f}},
		{point_d, {BLACK}, {0.0f, 1.0f}},
		// vertices do topo
		{point_e, {CYAN}, {0.0f, 0.0f}},
		{point_f, {WHITE}, {1.0f, 0.0f}},
		{point_g, {RED}, {1.0f, 1.0f}},
...
int main() {
	...
	//Carregando a geometria da Cubo
